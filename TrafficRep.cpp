...
glColor3f(1,0,0);
drawstring(450.0,700.0,0.0,"UNIVERSITY OF MUMBAI ");
glColor3f(0.7,0,1);
...
glColor3f(1,1,1);
drawstring(100,300,0.0,"ROHAN UDAY KHAMBEKAR");
glColor3f(1,0.5,0);
drawstring(980,400,0.0,"GUIDES:");
glColor3f(1,1,1);
drawstring(930,300,0.0,"Mr. MAHESH");
glColor3f(1,1,1);
drawstring(930,240,0.0,"  Mr. ABHIJIT");
glColor3f(1,0.1,1);
